...
export const metalImagePrompt = 'Reply with the number printed closest to a visible brown or gold mole face, as h1 through h9. If the board has no visible mole face, reply wait. Never hit a bomb.';
